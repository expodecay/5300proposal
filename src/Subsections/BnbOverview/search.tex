...
\subsection{Search Strategies}
	...
	\end{figure}
		\subsubsection{Depth-First}
			...
			When the current sum-problem is complete, the algorithm selects the next unexplored node for exploration and if one does not exist, the algorithm backtracks to the nearest ancestor node. 
